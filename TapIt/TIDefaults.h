...
//  TapIt
//
//  Created by Hyung-Suk Kim on 6/3/13.
//  Copyright (c) 2013 Hyung-Suk Kim. All rights reserved.
//

#ifndef TapIt_TIDefaults_h
#define TapIt_TIDefaults_h

static NSString* const kTIDefaultsInitialized = @"Initialized";

static NSString* const kTIDefaultsPreSession = @"PreSession";
